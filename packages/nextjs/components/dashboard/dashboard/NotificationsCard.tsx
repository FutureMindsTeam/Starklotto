            ...
            list.map((n) => (
              ...
              >
                <div className="mb-2 flex items-center gap-2">
                  <div className={`w-6 h-6 rounded-full flex items-center justify-center border ${n.type === "prize"
                  ...
                  <div className="font-medium text-white group-hover:text-starkYellow transition-colors">{n.title}</div>
                </div>

                <div className="mb-3 text-sm text-white/70 group-hover:text-white/80 transition-colors">{n.desc}</div>
                ...
                {n.cta && (
                  ...
                  >
                    <Link
                      href={n.cta.href}
                      className={`inline-flex items-center justify-center w-full px-4 py-2 rounded-lg font-medium text-sm transition-all duration-300 ${n.type === "prize"
