  ...
  return (
    <motion.div
      ...
      whileHover={{
        y: -6,
        scale: 1.03,
        boxShadow: '0 0 20px rgba(255,234,0,0.8), 0 0 40px rgba(255,234,0,0.4)',
      }}
    ...
    >
      ...
      <div className="
        ...
        group-hover:border-starkMagenta
        transition-colors duration-300
      " />

      <div className="relative z-10 mb-5 flex justify-center">
        <Icon className="h-10 w-10 text-starkMagenta" />
      </div>
...
export default function HowItWorks() {
  return (
    <section id="how" className="relative overflow-hidden py-24 text-white">
      {/* Match other sections’ background */}
